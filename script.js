document.addEventListener('DOMContentLoaded', () => {
    ...
    const duration = 2400;
    const steps = [
        { threshold: 20, text: 'Separando semente (e torcendo para dar certo, já que não sei como se planta rosas)...' },
        { threshold: 50, text: 'Sentindo o perfume no ar...' },
        { threshold: 80, text: 'Regando com um toque de carinho...' },
        { threshold: 95, text: 'As primeiras pétalas começam a surgir...' },
        { threshold: 100, text: 'Uma flor pronta para você!' }
    ];
